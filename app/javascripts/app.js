...
import voting_artifacts from '../../build/contracts/VoteWithTokens.json'

var VoteWithTokens = contract(voting_artifacts);
...
window.voteForCandidate = function(candidate) {
   ...
   */
  VoteWithTokens.deployed().then(function(contractInstance) {
...
$( document ).ready(function() {
  ...
  VoteWithTokens.setProvider(web3.currentProvider);
  populateCandidates();
